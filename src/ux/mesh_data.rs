...
const fn mirrored(point: Pos2, handle1: Vec2) -> CubicBezierPoint {
    CubicBezierPoint {
        point,
        handles: CubicBezierControl::Mirrored(handle1),
    }
}
...
const fn free(point: Pos2, handle1: Vec2, handle2: Vec2) -> CubicBezierPoint {
    CubicBezierPoint {
        point,
        handles: CubicBezierControl::Free(handle1, handle2),
    }
}
